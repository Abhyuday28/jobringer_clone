      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex space-x-4 lg:space-x-8">
            <a href="#" className="text-sm lg:text-base text-gray-700 hover:text-blue-600 transition font-medium whitespace-nowrap">
              My Dashboard
            </a>
            <a href="#" className="text-sm lg:text-base text-gray-700 hover:text-blue-600 transition font-medium whitespace-nowrap">
              Jobs
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:flex items-center space-x-2 bg-gray-100 px-3 py-2 rounded-full ml-4">
